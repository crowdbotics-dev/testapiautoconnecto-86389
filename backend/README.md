...
## Project Structure
    ...
    ├── testapiautoconnecto_86389  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_86389`
...
2. Clone this repo and `cd testapiautoconnecto_86389`
